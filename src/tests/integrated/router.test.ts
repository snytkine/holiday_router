...
describe('#Integrated Router test', () => {
  ...
  describe('#findRoute tests', () => {
    ...
    it('Should find route with extracted path parameters', () => {
      const res = <IRouteMatch<BasicController<string>>>router.findRoute('/catalog/toys/cars/toyota/rav4');
    ...
    it('should find route with path params in 2 uri segments', () => {
      const res = <IRouteMatch<BasicController<string>>>router.findRoute('/catalog/toys/cars/gm/mymodel-gtx-item/id-35.html');
      expect(res.controller.id)
      .to
      .equal('ctrl3');
    ...
    it('should find route with regex params', () => {
      const res = <IRouteMatch<BasicController<string>>>router.findRoute('/catalog/toys/cars/widget-678green/2015');
      expect(res.controller.id)
      .to
      .equal('ctrl4');
